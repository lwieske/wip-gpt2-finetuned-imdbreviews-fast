...
co2_eq_emissions:
  ...
  geographical_location: "Frankfurt an Main, Germany (500-600 gCO2eq/kWh)"
  hardware_used: "Apple Mac Studio 2022 || M1 Max/32GB RAM/10C CPU(8+2)/24C GPU"
---
543 gCO2eq/kWh
...
This model is a finetuned version of the [BERT base uncased
model](https://huggingface.co/bert-base-uncased) introduced in
[here](https://arxiv.org/abs/1910.01108).

The model is uncased: it does not differentiate between english
and English.
...
https://huggingface.co/Wakaka/bert-finetuned-imdb